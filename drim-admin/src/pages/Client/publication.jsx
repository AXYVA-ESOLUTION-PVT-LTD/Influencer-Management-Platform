...
function Publications() {
  ...
  const data = [
    ...
    },
    {
      ...
      author: "Jenette Caldwell",
      publicationDate: "2023/07/10",
      journal: "Security Weekly",
      volume: "5",
      pages: "95-105",
    },
    {
    ...
    },
    {
      ...
      author: "Tatyana Fitzpatrick",
      publicationDate: "2024/02/12",
      journal: "Automation Today",
      volume: "13",
      pages: "22-35",
    },
    {
    ...
    },
    {
      ...
      author: "Charde Marshall",
      publicationDate: "2024/04/15",
      journal: "Fintech Monthly",
      volume: "18",
      pages: "60-75",
    },
    {
    ...
    },
    {
      ...
      journal: "Tech and Society Review",
      volume: "23",
      pages: "110-125",
    },
    {
      ...
      author: "Colleen Hurst",
      publicationDate: "2024/08/12",
      journal: "Emerging Tech Journal",
      volume: "19",
      pages: "77-89",
    },
    {
        ...
        <Modal isOpen={modalOpen} toggle={toggleModal}>
          ...
          <ModalBody>
            {selectedPublication && (
              <div>
                <p>
                  <strong>Author:</strong> {selectedPublication.author}
                </p>
                <p>
                  <strong>Publication Date:</strong>{" "}
                ...
                <p>
                  <strong>Volume:</strong> {selectedPublication.volume}
                </p>
                <p>
                  <strong>Pages:</strong> {selectedPublication.pages}
                </p>
                <a
